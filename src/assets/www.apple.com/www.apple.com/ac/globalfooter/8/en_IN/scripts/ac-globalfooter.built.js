! function t(e, i, n) {
    ...
    3: [function(t, e, i) {
        ...
        e.exports = class {
            constructor(t, e) {
                e = Object.assign({}, s, e), this.el = t, this._selectors = {
                    wrapper: "." + e.className,
                    directory: e.directorySelector || `.${e.className}-directory`,
                    mini: e.miniSelector || `.${e.className}-mini`
                }, this._initializeDirectory(e), this._initializeLangLink()
            }
    ...
    7: [function(t, e, i) {
        ...
        class r extends n {
            constructor(t = {}) {
                super(), this.BREAKPOINTS = t.breakpoints || s, this._setupProperties(), this._onRetinaChange = this._onRetinaChange.bind(this), this._onOrientationChange = this._onOrientationChange.bind(this), this.listenersAdded = {
                    orientation: !1,
                    retina: !1,
                    viewport: !1
                }
    ...
    9: [function(t, e, i) {
        ...
        e.exports = class extends n {
            constructor(t) {
                ...
                new s(t).htmlClass(), this._initializeBuyStrip()
            }
            _initializeBuyStrip() {
                if (this._buystrip = this.el.querySelector(this._selectors.wrapper + "-buystrip"), !this._buystrip) return;
