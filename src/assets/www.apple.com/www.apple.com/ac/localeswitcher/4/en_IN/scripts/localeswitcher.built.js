! function e(t, n, r) {
    ...
    2: [function(e, t, n) {
        ...
        h._setup = function() {
            ...
            t.preventDefault(), this.previousNavItemIndex = this.focusedNavItemIndex, this.focusedNavItemIndex = this._calculateIndex(e, this.focusedNavItemIndex), this._navItems[this.focusedNavItemIndex].focus(), n || this.trigger(u.ONFOCUS, {
                event: t,
            ...
            this._allowMultiSelection || isNaN(this.selectedNavitemIndex) || this._navItems[this.selectedNavitemIndex].setAttribute(this._state, "false"), this.focusedNavItemIndex = e, this.selectedNavitemIndex = e, this._navItems[this.selectedNavitemIndex].setAttribute(this._state, "true"), t || this.trigger(u.ONSELECT, {
                event: null,
                index: this.focusedNavItemIndex,
                el: this._navItems[this.focusedNavItemIndex]
            })
    ...
    170: [function(e, t, n) {
        n.SourceMapGenerator = e(167).SourceMapGenerator, n.SourceMapConsumer = e(166).SourceMapConsumer, n.SourceNode = e(168).SourceNode
    }, {
        166: 166,
        167: 167,
        168: 168
    ...
    173: [function(e, t, n) {
        ...
        t.exports = class {
            constructor() {
                this._options = m, this._eventEmitterMicro = new i, this._setUserLangLocale(), this._userLangLocale && this._loadJson(this._userLangLocale), l() && (this.storageItem = new c("ls-opt-out"), this.storageItem.load()), this.focusedElementsId = null
            }
            _setUserLangLocale() {
            ...
            _setMetaData() {
                let e = {};
                e.optOutDismissalMax = parseInt(this._jsonData.localeswitcher.exit.metadata.dismiss), e.optOutDaysToExpiration = parseInt(this._jsonData.localeswitcher.exit.metadata.duration), this._options = Object.assign(m, e)
            }
            _addStyleSheet() {
                let e = this._getAcFilePath(this._userLangLocale) + this._options.fluidStyleSheetFilePath;
                const t = document.createElement("link");
                t.rel = "stylesheet", t.type = "text/css", t.href = e, t.addEventListener("load", this._loadStylesComplete.bind(this)), document.head.appendChild(t)
            }
            _loadStylesComplete() {
            ...
            _setUpEventListeners() {
                "ontouchstart" in document.documentElement ? document.addEventListener("touchstart", this._handleDropdownClickAway) : document.addEventListener("click", this._handleDropdownClickAway), this._closeButton.addEventListener("click", this._handleCloseBarEvent), this._closeButton.addEventListener("keydown", this._handleCloseBarKeyDownEvent.bind(this)), this._continueButton.addEventListener("click", this._handleContinueButtonEvent.bind(this)), this._initializeDropdownToggle()
            }
            ...
            _setDropdownLinks() {
                ...
                e = this._sortLinkIds(e, this._userLangLocale), this._listItems = Array.prototype.slice.call(this.el.querySelectorAll("." + this._selectors.dropdownOptionClass)), e.forEach((e, t) => {
            ...
            _onRAFDraw() {
                this._elHeight !== this._lastHeight && (document.documentElement.style["margin-top"] = this._elHeight, this.el.style.top = "-" + this._elHeight), this._lastHeight = this._elHeight
            }
            ...
            _handleCloseBarKeyDownEvent(e) {
                ...
                if (document.activeElement === t && ("Enter" === e.code || "Space" === e.code)) {
                    ...
                    e.length > 0 && (this.focusedElementsId = setTimeout(() => {
                        e[0].focus(), clearTimeout(this.focusedElementsId)
