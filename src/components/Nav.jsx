...
function Nav() {
  ...
  return (
    <div className='header'>
      ...
      <ul className={`ul_header ${menuOpen ? 'mobile-open' : ''}`}>
        <li onClick={closeMenu}><Link to="/">Store</Link></li>
        <li onClick={closeMenu}><Link to="/mac">Mac</Link></li>
        <li onClick={closeMenu}><Link to="/ipad">iPad</Link></li>
        <li onClick={closeMenu}><Link to="/iphone">iPhone</Link></li>
        <li onClick={closeMenu}><Link to="/watch">Watch</Link></li>
        <li onClick={closeMenu}><Link to="/air-pods">AirPods</Link></li>
        <li onClick={closeMenu}><Link to="/tv">TV & Home</Link></li>
        <li onClick={closeMenu}><Link to="/entertainment">Entertainment</Link></li>
      ...
      <div className="icons_right_header"></div>
    </div>
  )
}
